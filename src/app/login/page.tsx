    ...
    <div className='login-pane'>
      ...
      <div className='login_options'>
        <div className='option'>
          <div className='img'>
            <svg className='icon' xmlns="http://www.w3.org/2000/svg" fill="#000000" height="40px" width="40px" version="1.1" id="Layer_1" viewBox="0 0 512 512">
            <g>
              <g>
        ...
        <div className='option'>
          <div className='img'>
            <svg xmlns="http://www.w3.org/2000/svg"  width="40px" height="40px" viewBox="-0.5 0 48 48" version="1.1">
          ...
          <div className='captions'>Google</div>
        </div>
        <div className='option'>
          <div className='img'>
            <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="-1.5 0 20 20" version="1.1">
                ...
                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="Dribbble-Light-Preview" transform="translate(-102.000000, -7439.000000)" fill="#000000ff">
